...
export default function SidebarCard() {
    ...
    const buttons = [
        ...
        { label: "Display", icon: DisplayIcon, path: "/settings/display" },
    ...
    return (
        <div className="m-8 rounded-3xl shadow-lg border border-gray-200 p-3 transition-shadow duration-300 hover:shadow-xl w-full max-w-[18rem] bg-gray-100">
